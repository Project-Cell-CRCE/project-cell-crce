...
export function FeaturesSectionDemo() {
  const features = [
    {
      title: "Building Projects that help the college",
      description:
    ...
    },
    {
      title: "Our Projects",
      description:
        "Check out some of our latest projects built by us in the Project Cell.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Watch our Journey on YouTube",
      description: "See what we build, come with us on our Journey",
    ...
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div className="w-full p-5 mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          ...
          {/* <OrbitingCirclesDemo/> */}
          {/* <Image
            src="https://images.unsplash.com/photo-1629739884942-8678d138dd64?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="header"
            width={200}
            height={200}
